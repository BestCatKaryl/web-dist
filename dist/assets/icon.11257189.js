import{az as c,cC as h,cD as e,cE as o,cF as p,cG as n,cH as i,cI as m,cJ as f,cK as d,cL as F,cM as v,cN as E,cO as M,cP as u,cQ as H}from"./index.9c923db5.js";import{h as I,i as B,k as V,l as k}from"./index.27c6c4cc.js";import{I as x}from"./Layout.f3c4e2ff.js";import{a as A}from"./index.bce9104b.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function z(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function P(a){return c({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":f,"exe,msi":d,"zip,gz,rar,7z,tar,jar,xz":F,apk:x,db:I,md:v,epub:B,iso:V,m3u8:i,"doc,docx":E,"xls,xlsx":M,"ppt,pptx":u,pdf:H,psd:z,ai:D,url:k,cast:A},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return m;case l.VIDEO:return i;case l.AUDIO:return n;case l.TEXT:return p;case l.IMAGE:return o;default:return e}},O=a=>Z(a.type,h(a.name));export{P as A,l as O,O as g};
